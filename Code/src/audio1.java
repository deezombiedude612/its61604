...
public class audio1 {
    ...
    private int sendPort = 8080; //the port to which the agent wishes to send
    private int receivePort = 9090; //the agent own port, to listen on for traffic
    ...
    SourceDataLine sourceDataLine;
         ...
         public audio1() throws UnknownHostException{
